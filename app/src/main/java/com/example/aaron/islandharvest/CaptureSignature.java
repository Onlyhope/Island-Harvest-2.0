...
public class CaptureSignature extends AppCompatActivity {
    ...
    private boolean prepareDirectory() {
        try {
            ...
            e.printStackTrace();
            Toast.makeText(this, "Could not initiate File System.." +
                    "Is Sdcard mounted properly?", Toast.LENGTH_LONG).show();
            return false;
        }
    }
            ...
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    for (int i = 0; i < historySize; i++) {
                        ...
                        expandDirtyRect(historicalX, historicalX);
